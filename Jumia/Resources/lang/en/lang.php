...
return [
    ...
    'cscart_app_url' => 'cscart App URL',
    'cscart_consumer_key' => 'cscart Consumer Key',
    'cscart_consumer_secret' => 'cscart Consumer Secret',
    'sync_product_categories' => 'Sync Product Categories',
    'brands' => 'Brands',
    'categories' => 'Categories',
    'jumia_order_status' => 'Jumia order status',
    ...
    "sync_new_only" => "Sync new products only   ",
    "sync_only_update" => " Sync updated products only  ",
    "sync_all_stocks" => "Sync all  products stock  ",
    "select_jumia_brand" => "Select Jumia brand    ",
    "write_jumia_brand" => "Write Jumia brand   ",
    'jumia_category' => 'Jumia category',
    'jumia_module' => 'Jumia Module',
    'synced_successfully' => 'Synced successfully',
    'location_dropdown_help' => 'Location which will be used for cscart',
    'sync_all' => 'Sync all',
    'jumia_app_url' => 'jumia app url',
    'email' => 'Email',
    'api_key' => 'Api Key',
    'sync_only_new' => 'Sync only new',
    'sync_products' => 'Sync Products',
    'sync_all_help' => '<ul><li>Synchronizes all your products with the cscart App.</li><li><b><i>*(Time consuming process)</i></b></li><li>Please, Do not refresh or leave the page while synchronizing</li></ul>',
    'sync_new_help' => '<ul><li>Synchronizes only newly created products with the cscart App.</li><li><b><i>*(Less time consuming process)</i></b></li><li>Please, Do not refresh or leave the page while synchronizing</li></ul>',
    ...
    'equivalent_cscart_tax_rate' => 'Equivalent cscart Tax Rate',
    'default_tax_class' => 'Default Tax Class',
    'default_tax_class_help' => 'cscart Tax Class which will be set as default while synchronizing products. (Default: standard)',
    ...
    'product_fields_to_be_synced_for_create' => 'Product fields to be synced with cscart while creating products',
    'product_fields_to_be_synced_for_update' => 'Product fields to be synced with cscart while updating products',
    'price' => 'Price',
    'sync_log' => 'Sync Log',
    'operation' => 'Operation',
    'sync_type' => 'Sync Type',
    ...
    'ins_2' => 'Timezone of POS should be same as timezone of the cscart App',
    'unable_to_connect' => 'Unable to connect with cscart, Check API settings',
  ...
  'syncing' => 'Syncing',
    ...
    'cscart_module' => 'cscart Module',
    'version_info' => 'cscart module version - <code>:version</code>',
    ...
    'access_cscart_api_settings' => 'Access cscart API settings',
    'orders_sync_notification' => 'All cscart orders have been synced successfully',
    ...
    'cscart_disable_sync' => 'Disable cscart Sync',
    'cscart_disable_sync_help' => 'If checked this product will not be synced with cscart',
    ...
    'cscart_order_status' => 'cscart order status',
    ...
    'has been declined' => "has been declined",
    'has been backordered' => "has been backordered",
    'has been canceled' => "has been canceled",
    'has been processed' => "has been processed",
    'has been payment ways' => "has been payment ways",
    'has been repayment period' => "has been repayment period",
    'has been completed' => "has been completed",
    'has been order shipping' => "has been order shipping",
    'Revision and preparation in progress' => "Revision and preparation in progress",
